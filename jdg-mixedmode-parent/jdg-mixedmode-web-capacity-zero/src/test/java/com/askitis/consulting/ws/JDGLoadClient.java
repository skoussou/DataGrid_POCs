 ...
 */
public class JDGLoadClient implements RdsJDGDataLoadServiceZeroCapacity {
    private RdsJDGDataLoadServiceZeroCapacity jdgLoadService;
    ...
    public JDGLoadClient(final URL wsdlUrl) {
        ...
        jdgLoadService = service.getPort(RdsJDGDataLoadServiceZeroCapacity.class);
	...
	public Integer addJDGEntry(Mode mode, String cacheName) {
		return jdgLoadService.addJDGEntry(Mode.EMBEDDED, cacheName);
	}
