...
public final class HybridClassResolverOld implements ClassResolver {
	private ClassLoader classLoader;
	private HybridClassResolverOld(final ClassLoader classLoader) {
		this.classLoader = classLoader;
	}
	public static HybridClassResolverOld getInstance(final ClassLoader classLoader) {
		return new HybridClassResolverOld(classLoader);
	}
	/** {@inheritDoc} */
	@Override
