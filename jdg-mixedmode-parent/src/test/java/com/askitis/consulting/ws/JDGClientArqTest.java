...
public class JDGClientArqTest {
    ...
    private RdsJDGDataLoadServiceZeroCapacity client;

    @Deployment(testable = false)
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, APP_NAME + ".war").addPackage(RdsJDGDataLoadServiceZeroCapacity.class.getPackage())
    ...
    public void testHello() {
        ...
        final Integer response = client.addJDGEntry(Mode.EMBEDDED, CacheManagerProvider.CACHE_NAMES.RDS_SYNC_DIST.name());
